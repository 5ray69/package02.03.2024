...
directory_path = r"D:\Андрей\7fold\4 Взаимодействие с различными элементами Revit\4.4 Работа со связанными файлами\4.4 Задачи\Файл для задачи 4.4.5\Обновлены до версии2022"
