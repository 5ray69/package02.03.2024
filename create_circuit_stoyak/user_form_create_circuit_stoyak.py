...
class UserFormCreateCircuitStoyak(System.Windows.Forms.Form):
    def __init__(self):
        ...
        self.label1.Text = '   Если галку не поставить, то подключений к ВРУ не будет,\
                            \nнезависимо от того какой бы объект ВРУ для подключения\
                            \nмы не выбрали в этой форме ниже.\
                            \n   Если галку не поставить, то будут построены стояки только \
                            \nмежду элемантами, которые видимы на разрезе.'
        self.label1.Font = System.Drawing.Font(
                                'Arial',
                                System.Single(9),
                                System.Drawing.FontStyle.Italic,
                                System.Drawing.GraphicsUnit.Point)
        self.label1.Location = System.Drawing.Point(
            self.checkBox.Location.X, self.checkBox.Location.Y + 40)
        ...
        self.groupBox.Text = "Выберите к какому из объектов ВРУ выполнять подключение стояков"
