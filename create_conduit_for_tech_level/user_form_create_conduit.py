...
class UserFormCreateConduitForLevel(System.Windows.Forms.Form):
    def __init__(self, list_sorted_levels_names):
        self.list_sorted_levels_names = list_sorted_levels_names
        ...
        for name_level in self.list_sorted_levels_names:
            self._list_box.Items.Add(name_level)
